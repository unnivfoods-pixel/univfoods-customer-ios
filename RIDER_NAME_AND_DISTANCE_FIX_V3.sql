-- 🛰️ COMPLETE REPAIR V3: RIDER NAME + 15KM DISTANCE + OPEN/CLOSE TIMES
-- This script fixes the column error, enforces the 15km limit, and adds open/close times for real-time checks.
...
SELECT 
    ...
    r.name AS rider_name, -- 🛡️ FIXED COLUMN NAME HERE
...
BEGIN
    ...
    SELECT jsonb_agg(sub) INTO result FROM (
        SELECT 
            ...
            v.open_time, v.close_time, v.status -- 🛡️ ADDED FOR REAL-TIME STATUS
...
COMMIT;
SELECT 'DATABASE STABILIZED V3: OPEN TIMES ADDED' as status;
