-- 📍 TRACKING TRUTH PROTOCOL (V33.5)
-- 🎯 MISSION: Fix "customer_name specified more than once" conflict.
-- 🎯 MISSION: Real coordinates, Real locations.
...
SELECT 
    o.*,
    -- User Info (Renamed to avoid conflict if already in orders table)
