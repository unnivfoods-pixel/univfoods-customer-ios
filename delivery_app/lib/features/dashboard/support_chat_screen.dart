...
class _SupportChatScreenState extends State<SupportChatScreen> {
  ...
  Future<void> _sendMessage() async {
    ...
    final senderId = _userId ?? SupabaseConfig.forcedRiderId ?? 'GUEST_RIDER';
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text("Signal Fault: $e"), backgroundColor: Colors.red),
        );
      }
    }
  }
  ...
  Widget _buildMessageBubble(String text, bool isThem, String senderType) {
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isThem ? Colors.white : ProTheme.slate,
