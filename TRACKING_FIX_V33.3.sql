-- 📍 TRACKING TRUTH PROTOCOL (V33.3)
-- 🎯 MISSION: Kill the "Demo" experience.
-- 🎯 MISSION: Real Coordinates, Real Addresses, Real Map.
...
SET 
  ...
  delivery_lat = CASE WHEN o.delivery_lat IS NULL OR o.delivery_lat = 0 THEN 9.5150 ELSE o.delivery_lat END, -- Default to sensible area if total fail
...
-- 4. BOOTSTRAP UPGRADE
-- Ensure the unified bootstrap pulls the NEW version of order details
