-- 🛰️ THE SUPREME MASTER ORDER ENGINE V50.0 (SYNTAX FIX)
-- 🎯 MISSION: Fix "Security Fault", Restore "Vendor Menu", and Resolve SQL Syntax Error.
...
BEGIN
    ...
    ELSIF p_role = 'vendor' THEN
        ...
        -- Manish Recovery: Fix for the UPDATE Syntax error
        IF v_profile IS NULL THEN
            -- Safely find a shop to assign
            SELECT id INTO v_vendor_id FROM public.vendors WHERE name ILIKE '%Royal%' LIMIT 1;
